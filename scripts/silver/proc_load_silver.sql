...
Actions performed:    
    ...
    - Insert cleaned and transformed data from bronze tables into silver tables. 
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Logging start of Silver Layer load
        PRINT '====================================='
        ...
        *,
        ...
        PRINT '>> Load Time for silver.crm_cust_info: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Time for silver.crm_prd_info: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
        ...
        CASE
            WHEN sls_sales IS NULL OR sls_sales <=0 OR sls_sales != sls_quantity *ABS(sls_price) -- HAndling Missing data and invalid data 
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Time for silver.crm_sales_details: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Time for silver.erp_loc_a101: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Time for silver.erp_cust_az12: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
        ...
        SET @end_time = GETDATE();
        PRINT '>> Load Time for silver.erp_px_cat_g1v2: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT CHAR(10);
